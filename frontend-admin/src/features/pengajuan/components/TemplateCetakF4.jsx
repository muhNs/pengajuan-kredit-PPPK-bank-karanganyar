    ...
    >
        ...
        dangerouslySetInnerHTML={{
          __html: `
                @media print {
                    ...
                    /* 1. SEMBUNYIKAN SEMUA ELEMEN (Termasuk Sidebar) */
                    body * {
                        visibility: hidden;
                    }

                    /* 2. TAMPILKAN HANYA AREA CETAK */
                    #printable-area, #printable-area * {
                        visibility: visible;
                    }

                    /* 3. PAKSA PINDAH KE POJOK KIRI ATAS (Cabut dari struktur layout) */
                    #printable-area {
                    ...
                    /* 4. Hapus Sidebar, Navbar, Header secara fisik jika mereka pakai tag ini */
      ...
      <div className="w-full relative pt-1">
        ...
        <div className="mb-2">
          ...
          <table className="w-full mb-3 border-separate border-spacing-y-1">
            <tbody>
              <tr>
                <td className="w-[32%]">Nama Lengkap Sesuai KTP</td>
                <td className="w-[2%]">:</td>
              ...
              <tr>
                ...
                <td className="uppercase garis-bawah">
                  ...
                  {formData.pendapatan_tidak_tetap
                    ? formatRp(formData.pendapatan_tidak_tetap)
                    : "\u00A0"}
                </td>
              </tr>
              <tr>
        ...
        <p className="text-justify mb-2 leading-[1.1]">
          ...
          peraturan bank, saya bersedia membayar segala biaya yang timbul dari
          persyaratan pengajuan permohonan ini. Dokumen yang kami lampirkan
          tidak wajib dikembalikan apabila permohonan kami ditolak oleh bank.
        </p>
        ...
        <div className="avoid-break flex justify-between text-center mb-1">
          <div className="w-1/3 flex flex-col justify-between items-center">
            ...
            <div>
              ...
              <p className="leading-tight mt-1">NIP/NRP/NIK : {nipKepala}</p>
            </div>
          </div>
          ...
          <div className="w-1/3 flex flex-col justify-between items-center">
            ...
            <div>
              ...
              <p className="leading-tight mt-1">NIP/NRP/NIK : {nipBendahara}</p>
            </div>
          </div>
        </div>
      ...
      <div className="page-break w-full relative pt-4">
        ...
        <table className="w-full mb-6 border-separate border-spacing-y-2">
          <tbody>
            ...
            <tr>
              ...
              <td className="italic text-right">( Istri/Suami Debitur )</td>
            </tr>
            <tr>
              <td></td>
              <td>Alamat</td>
        ...
        <p className="mb-2 text-justify">
          Dengan ini menyatakan bahwa kami mengijinkan PT BPR Bank Karanganyar
          (Perseroda) untuk
        </p>
        <p className="mb-2 font-bold italic text-justify">
          Melakukan Analisa SLIK (Sistem Layanan Informasi Keuangan) atas
          data/identitas kami,
        </p>
      ...
      <div className="page-break w-full relative pt-6 px-4">
        ...
        <table className="w-full mb-6 border-separate border-spacing-y-2">
          <tbody>
            ...
            <tr>
              <td>NIK</td>
              <td>:</td>
              <td className="garis-bawah">{formData.nik || "\u00A0"}</td>
            </tr>
            <tr>
              <td>Dinas</td>
              <td>:</td>
            ...
            <tr>
              <td>NIP</td>
              <td>:</td>
              <td className="garis-bawah">{formData.nip || "\u00A0"}</td>
            </tr>
          </tbody>
        </table>

        <p className="mb-4">
          Bahwa saya Nasabah PT BPR Bank Karanganyar (Perseroda) dengan :
        </p>
        ...
        <p className="mb-4 text-justify leading-loose">
          Meminta kepada PT BPR Bank Karanganyar (Perseroda) untuk memotong
          penghasilan saya sebagai <br />
          <b>Pegawai Pemerintah Dengan Perjanjian Kerja Sebesar</b> Rp.{" "}
          <span className="garis-bawah inline-block min-w-[250px]">&nbsp;</span>
          <br />({" "}
          <span className="garis-bawah inline-block w-[95%]">
            &nbsp;
          </span> ) <br />
          setiap bulan sebagai angsuran Di PT BPR Bank Karanganyar (Perseroda)
          sampai dengan lunas.
        </p>

        <p className="mb-4 text-justify leading-relaxed">
          Dengan ini menyatakan bahwa saya adalah nasabah PT BPR Bank
          Karanganyar (Perseroda) dan apabila saya pensiun maupun keluar dari
          tempat/instansi/perusahaan saya bekerja, maka saya bersedia
          menyerahkan pesangon/asuransi/atau apapun yang saya terima dari
          tempat/instansi/perusahaan di mana saya pernah bekerja kepada
          Bendahara Gaji untuk pelunasan pinjaman saya di PT BPR Bank
          Karanganyar (Perseroda).
        </p>

        <p className="mb-8 text-justify leading-relaxed">
          Dan apabila masih terdapat kekurangan dalam pelunasan pinjaman saya di
          PT BPR Bank Karanganyar (Perseroda), maka saya bersedia menyerahkan
          agunan sebagai pengganti kekurangan pelunasan.
          <br />
          <br />
